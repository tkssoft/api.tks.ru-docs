...
| `ts_type`      | Тип транспортного средства                    | str    | `00_8703` - автомобиль, `00_8704` - самосвал, `01_8703` - квадроцикл, `02_8703` - гольф-кар, `03_8703101100` - снегоход, `04_8704` - грузовик, `05_870410` - самосвал, `06_8711` - мотоцикл, `07_8711201000` - мотороллер, `08_8711100000` - мопед, `09_8716400000` - автоприцеп, `10_871610` - дом-автоприцеп, `11_890399` - водный мотоцикл, `12_8903` - катер (яхта, лодка), `13_8702` - автобус |
| `mass`         | Масса                                         | int    | [0-9]+                                                                             |
