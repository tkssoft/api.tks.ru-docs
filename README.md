...
В случае существенного увеличения запросов (более 1 запроса в секунду), наличия признаков нештатной работы Лицензиар вправе ограничивать количество запросов, заблокировать пользователя или вводить дополнительную оплату. В случае применения таких ограничений Лицензиар по возможности информирует Лицензиата до начала или сразу после применения таких ограничений.
